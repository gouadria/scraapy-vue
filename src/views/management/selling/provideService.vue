...
import servicesDetails from '@/views/management/selling/orderDetails/servicesDetails.vue'
...
<template>
  ...
  <div class="provideService" v-else>
    <div class="header">
      <div class="text">
        <h1>{{ $t('Selling.services_provided') }}</h1>
        <p>{{ $t('Selling.services_provided_description') }}</p>
      </div>
    </div>
