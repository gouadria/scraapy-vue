...
export default defineComponent({
  ...
  data() {
    return {
      ...
      nextPageUrl: '/api/inventory/user/items/?category_group=service' as string | null,
...
async fetchCategories() {
  try {
    ...
    async updateItems() {
      this.loading = true
      try {
        const response = await this.$axios.get('/api/inventory/user/items/?category_group=service')
